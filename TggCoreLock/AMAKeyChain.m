...
+ (void)rhKeyChainSave:(NSString *)service {
    ...
    [tempDic setObject:service forKey:service];
    [self save:service data:tempDic];
}

+ (NSString *)rhKeyChainLoad:(NSString *)service {
    NSMutableDictionary *tempDic = (NSMutableDictionary *)[self load:service];
    return [tempDic objectForKey:service];
}
